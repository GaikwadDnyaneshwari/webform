...
$from_date = isset($_POST['from_date']) && !empty($_POST['from_date']) ? date('Y-m-d', strtotime($_POST['from_date'])) : null;

// $to_date = $_POST['to_date'];

// // Convert empty date input to NULL
// $to_date = !empty($to_date) ? date('Y-m-d', strtotime($to_date)) : null;
$to_date = isset($_POST['to_date']) && !empty($_POST['to_date']) ? date('Y-m-d', strtotime($_POST['to_date'])) : null;
...
$from_date1 = isset($_POST['from_date1']) && !empty($_POST['from_date1']) ? date('Y-m-d', strtotime($_POST['from_date1'])) : null;

// $to_date1 = $_POST['to_date1'];

// // Convert empty date input to NULL
// $to_date1 = !empty($to_date1) ? date('Y-m-d', strtotime($to_date1)) : null;
$to_date1 = isset($_POST['to_date1']) && !empty($_POST['to_date1']) ? date('Y-m-d', strtotime($_POST['to_date1'])) : null;
