...
// if ($signature === null) {
//     $signature_path = null;
// } elseif ($signature['error'] !== UPLOAD_ERR_OK) {
//     $signature_path = null;
// } else {
//     $uploadDirectory = 'uploads/';
