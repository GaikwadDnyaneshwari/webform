              ...
              <div class="col-md-12">
                <div class="form-bg" id="enrollment">
                    ...
                    <?php
                        ...
                        $query="SELECT * FROM students_form WHERE id='$id'";
                        ...
                        if(mysqli_num_rows($query_run)>0){
                            foreach( $query_run as $row){
                                ...
                                ?>
                                <form method="POST" enctype="multipart/form-data"  action="code.php" style="margin-top: 100px;">
                            <div>
                            ...
                            <img src="<?php  echo"uploads/".$row['photo'] ?>" alt="update" width="195px">
                                        ...
                                        <tr>
                                            <td>
                                               ...
                                               <input type="text" class="form-control" id="postgraduation_instituteName" name="postgraduation_instituteName"
                                                 placeholder="Enter Postgraduation Ex.MBA"  value='<?php echo $row["postgraduation_institute_name"]; ?>'  required></td>
                            ...
                            <div class="container mt-5">
                                ...
                                <footer>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- <label for="image-input" class="image-upload-box">
                                                        ...
                                                        <input type="file" id="image-input" name="signature" 
                                                            accept="image/*" onchange="checkImageSize()"  />
                                                            <span id="fileMessage" style="color: rgb(18, 17, 17);">File size must be less than 256 KB.</span>
                                                    </label> -->
                                                    <img src="<?php  echo"upload_sign/".$row['signature'] ?>" alt="update" >
                                                </div> 
                                    ...
                                    <div class="mt-4 text-center ">
                                        <button type="submit"name="update" class="btn btn-primary form-group">Update Student</button>
