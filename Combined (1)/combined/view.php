    ...
    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <select class="form-control" id="trainingCourse" name="trainingCourse" disabled>
                                            ...
                                            <option <?php if ($row["training_course"] == "Digital Marketing")
                                                echo "selected"; ?>>Digital Marketing</option>
                                            <option <?php if ($row["training_course"] == "Digital Marketing + Web Development")
                                                echo "selected"; ?>>Digital Marketing + Web Development
                                            </option>
                                            <option <?php if ($row["training_course"] == "Full Stack Development(java/phython)")
                                                echo "selected"; ?>>Full Stack Development(java/phython)
                                            </option>
                                            <option <?php if ($row["training_course"] == "Data Science (Basic to Advance)")
                                                echo "selected"; ?>>Data Science(Basic to Advance)</option>
                                            <option <?php if ($row["training_course"] == "(Integrated) Data Science")
                                                echo "selected"; ?>>(Integrated) Data Science</option>
                                            <option <?php if ($row["training_course"] == "Web Development")
                                                echo "selected"; ?>>Web Development</option>
                                            <option <?php if ($row["training_course"] == "PMO")
                                                echo "selected"; ?>>PMO</option>
                                            <option <?php if ($row["training_course"] == "SAP S4 hana")
                                                echo "selected"; ?>>SAP S4 hana</option>
                                            <option <?php if ($row["training_course"] == "Salesforce(including certification)")
                                                echo "selected"; ?>>Salesforce(including certification)</option>
                                            <option <?php if ($row["training_course"] == "AWS")
                                                echo "selected"; ?>>AWS</option>
                                            <option <?php if ($row["training_course"] == "Power BI")
                                                echo "selected"; ?>>Power BI</option>
                                            <option <?php if ($row["training_course"] == "Software Testing")
                                                echo "selected"; ?>>Software Testing</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 ">
                                        <select class="form-control" id="physicallyChallenged"
                                            ...
                                            <option <?php if ($row["physically_challenged"] == "Yes")
                                                echo "selected"; ?>  value="Yes">Yes</option>
                                            <option <?php if ($row["physically_challenged"] == "No")
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" name="ssc_instituteName"
                                                    ...
                                                    <option <?php if ($row["ssc_institute_name"] == "SSC")
                                                        echo "selected"; ?> value="SSC">SSC</option>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" name="hsc_instituteName"
                                                    ...
                                                    <option <?php if ($row["hsc_institute_name"] == "HSC")
                                                        echo "selected"; ?> value="HSC">HSC</option>
                                                    <option <?php if ($row["hsc_institute_name"] == "Diploma")
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="english_read" value="English"  <?php if ($row["english_read"] == "English")
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="english_write" value="English" <?php if ($row["english_write"] == "English")
                                                        echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_speak"
                                                    name="english_speak" value="English"<?php if ($row["english_speak"] == "English")
                                                        echo "checked"; ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="hindi_read" value="Hindi"<?php if ($row["hindi_read"] == "Hindi")
                                                        echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="hindi_write" value="Hindi"<?php if ($row["hindi_write"] == "Hindi")
                                                        echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_speak"
                                                    name="hindi_speak" value="Hindi"<?php if ($row["hindi_speak"] == "Hindi")
                                                        echo "checked"; ?> disabled>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_read"
                                                    name="marathi_read" value="Marathi"<?php if ($row["marathi_read"] == "Marathi")
                                                        echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input" id="can_write"
                                                    name="marathi_write" value="Marathi"<?php if ($row["marathi_write"] == "Marathi")
                                                        echo "checked"; ?> disabled>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="form-check-input " id="can_speak"
                                                    name="marathi_speak" value="Marathi"<?php if ($row["marathi_speak"] == "Marathi")
                                                        echo "checked"; ?> disabled>
                            ...
                            <div class="container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="experience" id="yes" value="yes"
                                      onchange="toggleTable()"<?php if ($row["experience"] == "yes")
                                          echo "checked"; ?> disabled>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="experience" id="no" value="no"
                                         onchange="toggleTable()"<?php if ($row["experience"] == "no")
                                             echo "checked"; ?> disabled>
                            ...
                            <div class="form-check form-check-inline ml-4">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="pune" value="Pune" <?php if ($row["preferred_job_location_pune"] == "Pune")
                                            echo "checked"; ?> disabled> Pune</label>
                            </div>
                            <div class="form-check  form-check-inline-sm ml-4">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="mumbai" value="Mumbai" <?php if ($row["preferred_job_location_mumbai"] == "Mumbai")
                                            echo "checked"; ?> disabled> Mumbai</label>
                            </div>
                            <div class="form-check form-check-inline ml-4 mb-3">
                                <label class="form-check-label"><input type="checkbox" class="form-check-input"
                                        name="bangalore" value="Bangalore" <?php if ($row["preferred_job_location_bangalore"] == "Bangalore")
                                            echo "checked"; ?> disabled> Bangalore</label>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" id="fee" name="fee"disabled required>
                                                    ...
                                                    <option value="Enrollment Fee" <?php if ($row["fee"] == "Enrollment Fee")
                                                        echo "selected"; ?>>Enrollment Fee</option>
                                            ...
                                            <td>
                                                <select class="form-control" id="Schedule" name="Schedule"disabled required>
                                                    <!-- <option value="" selected>select</option> -->
                                                    <option value="At the time of Enrollment"<?php if ($row["schedule"] == "At the time of Enrollment")
                                                        echo "selected"; ?>>At the time of Enrollment
                                                    </option>
                                                    <option value=" During the Trainig only"<?php if ($row["schedule"] == "During the Trainig only")
                                                        echo "selected"; ?>>During the Training only
                                                    </option>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-group form-inline">
                                        ...
                                        <select class="form-control mr-2" id="paymentMode" name="paymentMode"disabled required>
                                            <!-- <option value="" selected>Select an option</option> -->
                                            <option value="Online"<?php if ($row["payment_mode"] == "Online")
                                            ...
                                            <option value="Card"<?php if ($row["payment_mode"] == "Card")
                            ...
                            <div class="container mt-5">
                                ...
                                <div class="checkbox form-check">
                                    <label>
                                        <input type="radio" name="paymentType" value="One Time" id="oneTimeCheckbox" onchange="toggleTable()"
                                            <?php if ($row["payment_type"] == "One Time")
                                    ...
                                    <label><input type="radio" name="paymentType" value="EMI" id="emiCheckbox"
                                            onchange="togglePaymentTable(true)"<?php if ($row["payment_type"] == "EMI")
                                                echo "checked disabled"; ?> disabled> EMI(Fees to be paid in 3
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_1" id="EMI_NO_1" disabled>
                                                        <option value="EMI NO 1"<?php if ($row["emi_no_1"] == "EMI NO 1")
                                                            echo "selected"; ?>>EMI NO 1</option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_2" id="EMI_NO_2" disabled>
                                                        <option value="EMI NO 2"<?php if ($row["emi_no_2"] == "EMI NO 2")
                                                            echo "selected"; ?>>EMI NO 2</option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="EMI_NO_3" id="EMI_NO_3" disabled>
                                                        <option value="EMI NO 3"<?php if ($row["emi_no_3"] == "EMI NO 3")
                                                            echo "selected"; ?>>EMI NO 3</option>
                                                    </select>
                                                </td>
                                ...
                                <div class="checkbox form-check">
                                        <div id="agreeContinueCheckbox1" class="form-check pb-3 hidden">
                                            <input class="form-check-input" type="checkbox" id="agreeCheckbox"  <?php if ($row["payment_type"] == "EMI")
                                                echo "checked"; ?> disabled>
                                        ...
                                        <label><input type="radio" id="loanCheckbox" name="paymentType" value="Loan" onchange="toggleTable()"
                                                <?php if ($row["payment_type"] == "Loan")
                                                    echo "checked disabled"; ?> disabled > Loan (Documents to be
                                            Submitted within 8
                                            days of
                                            registration)</label>
                                </div>
